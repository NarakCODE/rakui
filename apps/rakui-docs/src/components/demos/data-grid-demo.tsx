...
export function DataGridDemo() {
  ...
  // Generate faker data client-side only to avoid SSR/client hydration mismatch
  React.useEffect(() => {
  ...
  return (
    <div className="w-full space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold">Skate Tricks Data</h3>
