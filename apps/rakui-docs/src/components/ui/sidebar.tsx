      ...
      return (
        ...
        >
          <div
            ...
            data-mobile="true"
            className="fixed top-0 left-0 h-svh w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground transition-transform duration-300 ease-in-out"
            style={{
        ...
        >
          <div
            ...
            className={cn(
              ...
              variant === "inset" && "m-2 rounded-lg border border-sidebar-border bg-background shadow-sm"
            )}
          >
            {children}
          </div>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "[[data-state=collapsed]_&]:cursor-default",
        className
      )}
      {...props}
    />
