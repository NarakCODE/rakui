...
const orientationConfig: Record<
  ...
  {
    modifiers: NonNullable<DndContextProps["modifiers"]>;
    strategy: SortableContextProps["strategy"];
    collisionDetection: NonNullable<DndContextProps["collisionDetection"]>;
  }
> = {
  vertical: {
...
function Sortable<T>(props: SortableProps<T>) {
  ...
  const onDragEnd = React.useCallback(
    ...
    [getItemValue, onDragEndProp, onMove, onValueChange, value],
  );
...
function SortableItem(props: SortableItemProps) {
  ...
  const itemContext = React.useMemo<SortableItemContextValue>(
    ...
    [attributes, disabled, id, isDragging, listeners, setActivatorNodeRef],
  );
